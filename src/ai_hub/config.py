...
MANAGER_DEBUG_LOG_PROMPTS = _env_flag("MANAGER_DEBUG_LOG_PROMPTS", True)
MANAGER_DEBUG_LOG_MAX_CHARS = _env_int("MANAGER_DEBUG_LOG_MAX_CHARS", 16000)
RESEARCH_DEBUG_LOG_PROMPTS = _env_flag("RESEARCH_DEBUG_LOG_PROMPTS", True)
RESEARCH_DEBUG_LOG_MAX_CHARS = _env_int("RESEARCH_DEBUG_LOG_MAX_CHARS", 16000)
EXPLORER_DEBUG_LOG_PROMPTS = _env_flag("EXPLORER_DEBUG_LOG_PROMPTS", True)
EXPLORER_DEBUG_LOG_MAX_CHARS = _env_int("EXPLORER_DEBUG_LOG_MAX_CHARS", 16000)
CODING_DEBUG_LOG_PROMPTS = _env_flag("CODING_DEBUG_LOG_PROMPTS", True)
CODING_DEBUG_LOG_MAX_CHARS = _env_int("CODING_DEBUG_LOG_MAX_CHARS", 16000)
